...
# read data
PRIMARY_DATA_FILEPATH = f"{OUTPUT_DIRECTORY}{os.sep}f2022_tcp_by_polling_place_pc.csv"
...
df_other_data.rename(columns={"SA1_Total_Votes": "tcp_tot_f2022"}, inplace=True)

print(df_output)
df_output.to_csv(
    f"{OUTPUT_DIRECTORY}{os.sep}f2022_tcp_by_SA1_2016.csv", encoding="UTF8", index=False
)
